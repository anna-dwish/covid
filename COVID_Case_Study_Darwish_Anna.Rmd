...
# Called rjags_model
load(file="beta_0_10-a_0_20-b_0_20/full-intrxn-no-health-alpha_0_1-beta_0_10-a_0_20-b_0_20.Rdata")
...
generate_density_df <- function(prior_meta,
  ...
  if(final_model){
    ...
    prior_lab <- " ~ N(0,1/10); a,b ~ N(0,1/20)"
    line_type = "solid"
  }
  else{
...
priors <- list(list("beta_0_15-a_0_15-b_0_15/full-intrxn-no-health-beta_0_15-a_0_15-b_0_15.Rdata",
...
```{r b sensitivity plots display, fig.align="center", fig.width=8.5, fig.height=3.5}
b_prior_plot <- b_df  %>% 
  ggplot() + 
