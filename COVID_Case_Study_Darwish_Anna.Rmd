...
Thus, our model predicts that the odds of an available *ESDA* response from an NC resident who is not socially distancing is between `r exp(mnar.final.model.df["b", "mean"] - 1.96 * mnar.final.model.df["b", "sd"])` and 
`r exp(mnar.final.model.df["b", "mean"] + 1.96 * mnar.final.model.df["b", "sd"])` times less than that of an NC resident who is socially distancing.
